...
String TAG="TruePrefUtilsClass";
    ...
    public void zUpdateUnitsData(boolean limitActivated, boolean adsActivated, int clicks, int impressions, long delayMs, int banHours, boolean hideOnClick) {
        ...
        editor.apply();
        Log.d(TAG, "zUpdateUnitsData: "+limitActivated);
    }

    public void zUpdateNetworksData() {
        editor.putBoolean(LABEL_NETWORK_ADMOB, true);
        editor.apply();
    }
